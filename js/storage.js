...
const defaultState = () => ({ version: 1, settings: { workMinutes: 25, breakMinutes: 5, autoLoop: false, stopwatchAutoStopSeconds: 0, rainEnabled: false, rainVolume: 0.35, alertEnabled: true, alertVolume: 0.7, wallpaper: 'light', themeMode: 'manual', enterToStart: false, zenMode: false }, sessions: [], activeTimer: null, activeStopwatch: null, pomodoroResetAt: null });
